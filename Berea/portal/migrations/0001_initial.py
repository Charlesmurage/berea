<<<<<<< HEAD
# Generated by Django 3.0.6 on 2020-05-20 08:06
=======
...
<<<<<<< HEAD
            name='units',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='portal.Unit'),
=======
            name='students',
            field=models.ManyToManyField(related_name='Student', through='portal.Membership', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='student',
            name='classroom_id',
